...
public final class SearchGuardLicense implements Writeable {
    ...
    public static SearchGuardLicense createTrialLicense(String issueDate, ClusterService clusterService, String msg) {
        final SearchGuardLicense trialLicense =  
        		new SearchGuardLicense("384EC11B-0275-4154-9E38-A83CB7469C4D", 
        				Type.FULL, issueDate, addDays(issueDate, 6100L), 
        				"Duoyi Network Co. Ltd.", "floragunn GmbH", issueDate, 6, 
        				"*", Integer.MAX_VALUE, clusterService);
        if(msg != null) {
